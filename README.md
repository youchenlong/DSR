...
## Run an experiment 
```shell
python src/main.py --config=dsr --env-config=foraging with buffer_size=5000 t_max=4050000
```
```shell
python src/main.py --config=dsr --env-config=pred_prey_punish with buffer_size=5000 t_max=2050000
```
```shell
python src/main.py --config=dsr --env-config=sc2 with env_args.map_name=MMM2 buffer_size=5000 t_max=2050000
```
